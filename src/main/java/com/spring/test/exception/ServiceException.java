...
import com.spring.test.domain.ServiceErrorCodeEnum;
...
public class ServiceException extends Exception {
     ...
     *
     */
    public ServiceException(ServiceErrorCodeEnum errEnum) {
        this.errorCode = errEnum.getCode();
        this.message = new StringBuffer("error info is:").append(errEnum.getErrorMes()).toString();
    }

    public ServiceException(ServiceErrorCodeEnum errEnum, String errorMes) {
        this.errorCode = errEnum.getCode();
        this.message = new StringBuffer(errorMes).append(errEnum.getErrorMes()).toString();
    }
     ...
     * @param args 异常信息中的参数
     */
    public ServiceException(String errorCode, Throwable cause, Object ... params) {
        fillInStackTrace();
        this.errorCode = errorCode;
        this.params = params;
        this.message = new StringBuffer("error code is:").append(errorCode).toString();
